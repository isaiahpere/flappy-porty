  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        <span className="text-primary font-medium text-3xl mb-2 dark:text-primaryDark">
          {type}
        </span>
        <Link href={link} className="hover:underline underline-offset-2">
          <h2 className="my-4 w-full text-left text-4xl font-bold dark:text-light">
            {title}
          </h2>
        </Link>
...
const Project = ({ title, type, image, link, githubLink }) => {
  return (
    <article className="w-full flex flex-col item-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        <span className="text-primary  mb-2 dark:text-primaryDark">{type}</span>
        <Link href={link} className="hover:underline underline-offset-2">
